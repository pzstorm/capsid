...
public final class AssertProcessor {
	...
	private static final VarType CLASS_ASSERTION_ERROR = new VarType(CodeConstants.TYPE_OBJECT, 0, "java/lang" +
			"/AssertionError");
			...
			if (exprent.type == Exprent.EXPRENT_FUNCTION)
			{
						...
						fparam.getLstOperands().get(0).type == Exprent.EXPRENT_FIELD)
				{
					...
					return classname.equals(fdparam.getClassname()) &&
							key.equals(InterpreterUtil.makeUniqueKey(fdparam.getName(),
