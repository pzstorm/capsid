...
public final class GenericMain {
	...
	public static GenericClassDescriptor parseClassSignature(String signature) {
		...
		{
			DecompilerContext.getLogger().writeMessage("Invalid signature: " + original,
	...
	public static GenericFieldDescriptor parseFieldSignature(String signature) {
		...
		{
			DecompilerContext.getLogger().writeMessage("Invalid signature: " + signature,
					IFernflowerLogger.Severity.WARN);
			return null;
		}
	}
	...
	public static GenericMethodDescriptor parseMethodSignature(String signature) {
		...
		try {
			...
			return new GenericMethodDescriptor(typeParameters, typeParameterBounds, parameterTypes, returnType,
					exceptionTypes);
		}
		catch (RuntimeException e)
		{
	...
	private static String parseFormalParameters(String signature, List<? super String> parameters, List<?
			super List<GenericType>> bounds) {
