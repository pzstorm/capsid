...
public final class InstructionImpact {
	...
	private static final int[][][] stack_impact = {
			...
			{ null, null },                                                //		public final static int
			// opc_nop = 0;
			null,                                                                //		public final static int
			// opc_aconst_null = 1;
			null,                                                                //		public final static int
			// opc_iconst_m1 = 2;
			null,                                                                //		public final static int
			...
			{ null, { CodeConstants.TYPE_LONG } },                        //		public final static int
			// opc_lconst_0 = 9;
			{ null, { CodeConstants.TYPE_LONG } },                        //		public final static int
			// opc_lconst_1 = 10;
			{ null, { CodeConstants.TYPE_FLOAT } },                        //		public final static int
			// opc_fconst_0 = 11;
			{ null, { CodeConstants.TYPE_FLOAT } },                        //		public final static int
			// opc_fconst_1 = 12;
			{ null, { CodeConstants.TYPE_FLOAT } },                        //		public final static int
			// opc_fconst_2 = 13;
			{ null, { CodeConstants.TYPE_DOUBLE } },                        //		public final static int
			// opc_dconst_0 = 14;
			{ null, { CodeConstants.TYPE_DOUBLE } },                        //		public final static int
			// opc_dconst_1 = 15;
			{ null, { CodeConstants.TYPE_INT } },                        //		public final static int		opc_bipush
			// = 16;
			{ null, { CodeConstants.TYPE_INT } },                        //		public final static int		opc_sipush
			// = 17;
			...
			{ null, { CodeConstants.TYPE_INT } },                        //		public final static int		opc_iload
			// = 21;
			{ null, { CodeConstants.TYPE_LONG } },                        //		public final static int
			// opc_lload = 22;
			{ null, { CodeConstants.TYPE_FLOAT } },                        //		public final static int
			...
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_istore
			// = 54;
			{ { CodeConstants.TYPE_LONG }, null },                        //		public final static int
			// opc_lstore = 55;
			{ { CodeConstants.TYPE_FLOAT }, null },                        //		public final static int
			// opc_fstore = 56;
			{ { CodeConstants.TYPE_DOUBLE }, null },                        //		public final static int
			// opc_dstore = 57;
			...
			{ { CodeConstants.TYPE_ANY }, null },                        //		public final static int		opc_pop =
			// 87;
			{ { CodeConstants.TYPE_ANY, CodeConstants.TYPE_ANY }, null },                        //		public final
			...
			{ { CodeConstants.TYPE_INT }, { CodeConstants.TYPE_INT } },                        //		public final
			// static int		opc_ineg = 116;
			{ { CodeConstants.TYPE_LONG }, { CodeConstants.TYPE_LONG } },                        //		public final
			// static int		opc_lneg = 117;
			{ { CodeConstants.TYPE_FLOAT }, { CodeConstants.TYPE_FLOAT } },                        //		public
			// final static int		opc_fneg = 118;
			{ { CodeConstants.TYPE_DOUBLE }, { CodeConstants.TYPE_DOUBLE } },                        //		public
			...
			{ { CodeConstants.TYPE_INT }, { CodeConstants.TYPE_LONG } },                        //		public final
			// static int		opc_i2l = 133;
			{ { CodeConstants.TYPE_INT }, { CodeConstants.TYPE_FLOAT } },                        //		public final
			// static int		opc_i2f = 134;
			{ { CodeConstants.TYPE_INT }, { CodeConstants.TYPE_DOUBLE } },                        //		public
			// final static int		opc_i2d = 135;
			{ { CodeConstants.TYPE_LONG }, { CodeConstants.TYPE_INT } },                        //		public final
			// static int		opc_l2i = 136;
			{ { CodeConstants.TYPE_LONG }, { CodeConstants.TYPE_FLOAT } },                        //		public
			// final static int		opc_l2f = 137;
			{ { CodeConstants.TYPE_LONG }, { CodeConstants.TYPE_DOUBLE } },                        //		public
			// final static int		opc_l2d = 138;
			{ { CodeConstants.TYPE_FLOAT }, { CodeConstants.TYPE_INT } },                        //		public final
			// static int		opc_f2i = 139;
			{ { CodeConstants.TYPE_FLOAT }, { CodeConstants.TYPE_LONG } },                        //		public
			// final static int		opc_f2l = 140;
			{ { CodeConstants.TYPE_FLOAT }, { CodeConstants.TYPE_DOUBLE } },                        //		public
			// final static int		opc_f2d = 141;
			{ { CodeConstants.TYPE_DOUBLE }, { CodeConstants.TYPE_INT } },                        //		public
			// final static int		opc_d2i = 142;
			{ { CodeConstants.TYPE_DOUBLE }, { CodeConstants.TYPE_LONG } },                        //		public
			// final static int		opc_d2l = 143;
			{ { CodeConstants.TYPE_DOUBLE }, { CodeConstants.TYPE_FLOAT } },                        //		public
			...
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_ifeq =
			// 153;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_ifne =
			// 154;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_iflt =
			// 155;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_ifge =
			// 156;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_ifgt =
			// 157;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int		opc_ifle =
			// 158;
			{ { CodeConstants.TYPE_INT, CodeConstants.TYPE_INT }, null },                        //		public final
			...
			{ null, { CodeConstants.TYPE_ADDRESS } },                        //		public final static int
			// opc_jsr = 168;
			{ null, null },                        //		public final static int		opc_ret = 169;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int
			// opc_tableswitch = 170;
			{ { CodeConstants.TYPE_INT }, null },                        //		public final static int
			...
			{ { CodeConstants.TYPE_DOUBLE }, null },                        //		public final static int
			// opc_dreturn = 175;
			{ { CodeConstants.TYPE_OBJECT }, null },                        //		public final static int
			// opc_areturn = 176;
			...
			{ { CodeConstants.TYPE_OBJECT }, { CodeConstants.TYPE_INT } },                        //		public
