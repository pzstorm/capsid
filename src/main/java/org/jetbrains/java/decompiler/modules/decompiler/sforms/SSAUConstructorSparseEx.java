...
public class SSAUConstructorSparseEx {
	...
	//private HashMap<String, HashMap<Integer, FastSet<Integer>>> outVarVersions = new HashMap<String,
	...
	private void ssaStatements(DirectGraph dgraph, HashSet<String> updated, boolean calcLiveVars) {
		...
		for (DirectNode node : dgraph.nodes)
		{
			...
			// quick solution: 'dummy' field variables should not cross basic block borders (otherwise problems e.g.
			// with finally loops - usage without assignment in a loop)
				...
				switch (func.getFuncType())
				{
					...
					case FunctionExprent.FUNCTION_CADD:
						...
						SFormsFastMapDirect[] varmaparrAnd =
								new SFormsFastMapDirect[]{ new SFormsFastMapDirect(varmaparr[0]), null };
					...
					case FunctionExprent.FUNCTION_COR:
						...
						SFormsFastMapDirect[] varmaparrOr =
								new SFormsFastMapDirect[]{ new SFormsFastMapDirect(varmaparr[varmaparr[1] == null ? 0
										: 1]), null };
